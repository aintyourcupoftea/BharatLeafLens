...
class TestProgressBar extends StatefulWidget {
  final File image;
  const TestProgressBar({Key? key, required this.image}) : super(key: key);

  @override
  _TestProgressBar createState() => _TestProgressBar();
}

class _TestProgressBar extends State<TestProgressBar> {
  String label = '';
